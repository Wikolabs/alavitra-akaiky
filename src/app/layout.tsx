...
export const metadata: Metadata = {
  title: "AlavitraAkaiky.mg — Plateforme pastorale en ligne (confession, sermons, fotom-bavaka)",
  description: "Pasteurs et pretres accompagnent en ligne les personnes ne pouvant se rendre a l'eglise. Lavitra fa akaiky.",
};
